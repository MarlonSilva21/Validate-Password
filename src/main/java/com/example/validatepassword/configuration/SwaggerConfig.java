package com.example.validatepassword.configuration;
...
public class SwaggerConfig {
    public static ApiInfo metadata() {
        return new ApiInfoBuilder()
                .title("API - Validate Password")
                .description("Project API Spring - Validate Password")
                .version("1.0.0")
                .license("Apache License Version 2.0")
                .licenseUrl("https://github.com/MarlonSilva21")
                .contact(contact())
                .build();
    }

    private static Contact contact() {
        return new Contact("Marlon Silva",
                "https://github.com/MarlonSilva21",
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.example.validatepassword.controller"))
